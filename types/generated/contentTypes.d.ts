...
export interface ApiArticoloGdprArticoloGdpr extends Schema.CollectionType {
...
export interface ApiOwaspOwasp extends Schema.CollectionType {
  ...
  attributes: {
    ...
    cwes: Attribute.Relation<'api::owasp.owasp', 'oneToMany', 'api::cwe.cwe'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiPatternPattern extends Schema.CollectionType {
  ...
  attributes: {
    ...
    >;
    articolo_gdprs: Attribute.Relation<
      'api::pattern.pattern',
      'oneToMany',
      'api::articolo-gdpr.articolo-gdpr'
    >;
    iso_phases: Attribute.Relation<
      'api::pattern.pattern',
      'oneToMany',
      'api::iso.iso'
    >;
    principis: Attribute.Relation<
      'api::pattern.pattern',
      'oneToMany',
      'api::principi.principi'
    >;
    esempi: Attribute.RichText &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    collocazioneMVC: Attribute.RichText &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    feedback: Attribute.Decimal &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiStrategiaStrategia extends Schema.CollectionType {
  ...
  attributes: {
    ...
    tipo: Attribute.Enumeration<['DATA', 'PROCESS']> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
